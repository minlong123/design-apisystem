...
use app\admin\library\Aliossfileupnot;
...
class Ajax extends Backend
{
    ...
    public function upload()
    {
        ...
        if ($chunkid) {
            ...
            // {"admin_id":1,"filename":"loves (1).jpg","filesize":64578,"imagewidth":391,"imageheight":391,"imagetype":"jpg","mimetype":"image\/jpeg","url":"\/uploads\/77c9275b0ca55fcbfa786b77c1b188b4.jpg","uploadtime":1670327384,"storage":"local","sha1":"5ed6781ec14706790b62e339eb75a6947b3bb8d5","category":"unclassed","createtime":1670327384,"updatetime":1670327384,"thumb_style":""}
            $aliy=new Aliossfileupnot();
            $aliy->getnewimg(ROOT_PATH."public/".$attachment->url);
