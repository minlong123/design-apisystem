define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'waterphoto/index' + location.search,
                    add_url: 'waterphoto/add',
                    edit_url: 'waterphoto/edit',
                    del_url: 'waterphoto/del',
                    multi_url: 'waterphoto/multi',
                    import_url: 'waterphoto/import',
                    table: 'waterphoto',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'photosize', title: __('Photosize'), operate: 'LIKE'},
                        {
