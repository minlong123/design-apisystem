define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fontcolor/index' + location.search,
                    add_url: 'fontcolor/add',
                    edit_url: 'fontcolor/edit',
                    del_url: 'fontcolor/del',
                    multi_url: 'fontcolor/multi',
                    import_url: 'fontcolor/import',
                    table: 'fontcolor',
                }
            });
